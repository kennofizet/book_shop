...
<div id="content" class="fl-right">
    ...
    <div class="section" id="detail-page">
        <div class="section-detail">
            <form method="POST" id="form-add-new-post-blog" action="" enctype="multipart/form-data">
                {{csrf_field()}}
                <label for="title">Tiêu đề</label>
                <input type="text" name="title" id="title" style="width: 100%">

                <div style="margin-top: 20px">
                    <label for="desc-title-content-blog">Nội dung tóm tắt</label>
                    <div style="margin-top: 20px">
                        <textarea id="desc-title-content-blog" class="ckeditor" style="margin-top: 20px"></textarea>
                    </div>
                </div>
                
                <div style="margin-top: 20px">
                    <label for="desc-detail-content-blog">Nội dung</label>
                    <textarea id="desc-detail-content-blog" class="ckeditor" style="margin-top: 20px"></textarea>
                </div>
...
<script type="text/javascript">
    jQuery(function($) {
      $('#form-add-new-post-blog').on('submit',function(e){
          e.preventDefault();
          $.ajax({
            url:"{{ route('source.api.admin.blog.add-post') }}",
            method:"POST",
