...
!function($) {
    ...
    var TodoApp = function() {
        var _token = $('input[name="_token"]').val();
         $.ajax({
          url:"{{ route('api.get-todo-list-fl-user-index',{{Auth::user()->id}},'login-maganer') }}",
          method:"GET",
    ...
    TodoApp.prototype.init = function () {
        ...
        this.$todoBtn.on("click", function() {
            if ($this.$todoInput.val() == ""|| $this.$todoInput.val() == null) {
                Swal.fire({
                  icon: 'Lỗi',
                  title: 'Oops...',
                  text: 'Có một chút vấn đề!',
                  footer: 'Bạn quên nhập dữ liệu?</a>'
                })
